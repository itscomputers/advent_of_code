require 'year2020/day20'

describe Year2020::Day20 do
  let(:day) { Year2020::Day20.new }
  let(:raw_input) do
    <<~INPUT
      Tile 2311:
      ..##.#..#.
  ...
  describe Year2020::Day20::ImageAssembler do
    ...
    describe "grid" do
      ...
      it "up to symmetry it is the same as the representation" do
        expect(Year2020::Day20::GridOperations.ref_0(grid, 24)).to eq expected_grid
      end
    end
  end

  describe Year2020::Day20::TileConfiguration do
